...
void main() {
  ...
  // Pattern based on original UVs (no displacement)
  float f = pattern(uv);
  
  // Clean "delete" interaction
  if (enableMouseInteraction == 1) {
    ...
    // Clear hole: 0 inside radius, fade out to pattern quickly
    f *= smoothstep(0.0, mouseRadius * 0.8, dist); 
  }
...
function DitheredWaves({
  ...
  const waveUniformsRef = useRef(initialUniforms);
...
export default function Dither({
  ...
  waveFrequency = 3,
  waveAmplitude = 0.3,
  waveColor = [0.05, 0.05, 0.05], // Adjusted default to match dark theme
  colorNum = 4,
  pixelSize = 2,
